namespace Ahmad_Saleem_and_Company.App
{
    partial class PayableViewForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.payablereportBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.payablereportBindingSource)).BeginInit();
            ...
            reportDataSource1.Name = "PayableDataSet";
            reportDataSource1.Value = this.ledgersystemDataSetBindingSource;
            this.reportViewer2.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer2.LocalReport.ReportEmbeddedResource = "Ahmad_Saleem_and_Company.PayableReport.rdlc";
            this.reportViewer2.Location = new System.Drawing.Point(0, 0);
            this.reportViewer2.Name = "reportViewer2";
            this.reportViewer2.ServerReport.BearerToken = null;
            this.reportViewer2.Size = new System.Drawing.Size(1044, 751);
            ...
            // 
            // payablereportBindingSource
            // 
            this.payablereportBindingSource.DataMember = "payablereport";
            this.payablereportBindingSource.DataSource = this.ledger_systemDataSet;
            // 
            ...
            this.Name = "PayableViewForm";
            this.Load += new System.EventHandler(this.PayableViewForm_Load_1);
            ((System.ComponentModel.ISupportInitialize)(this.ledger_systemDataSet)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.payablereportBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource payablereportBindingSource;
